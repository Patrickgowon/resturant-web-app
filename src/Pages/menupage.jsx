  ...
  return (
    <div className="mt-18">
      ...
      <section className="flex justify-center sm:gap-4 gap-3 py-8">
        <button
          onClick={() => setData(1)}
          className={`${data == 1 ? "bg-red-500 text-white px-4 py-2 rounded hover:bg-red-600" : "bg-gray-200"} sm:px-4 px-1 sm:text-sm text-xs py-2 rounded`}
        >
          All
        </button>
        <button
          onClick={() => setData(2)}
          className={`${data == 2 ? "bg-red-500 text-white sm:px-4 px-1 py-2 rounded" : "bg-gray-200"} sm:px-4 px-2 sm:text-sm text-xs py-2 rounded`}
        >
          Breakfast
        </button>
        <button
          onClick={() => setData(3)}
          className={`${data == 3 ? "bg-red-500 text-white px-4 py-2 rounded" : "bg-gray-200"} sm:px-4 px-2 sm:text-sm text-xs py-2 rounded`}
        >
          Lunch
        </button>
        <button
          onClick={() => setData(4)}
          className={`${data == 4 ? "bg-red-500 text-white px-4 py-2 rounded" : "bg-gray-200"} sm:px-4 px-2 sm:text-sm text-xs py-2 rounded`}
        >
          Dinner
        </button>
        <button
          onClick={() => setData(5)}
          className={`${data == 5 ? "bg-red-500 text-white px-4 py-2 rounded" : "bg-gray-200"} sm:px-4 px-2 sm:text-sm text-xs py-2 rounded`}
        >
          Drinks
        </button>
      </section>
                ...
                <button
                  onClick={() =>
                    addToCart({
                      ...
                      description: "Crispy crust with melted cheese and spicy pepperoni",
                      price: 12.99,
              ...
              <div className="flex justify-between items-center gap-2">
                ...
                <button
                  onClick={() =>
                    addToCart({
                      name: "Creamy Pasta",
                      description: "Italian-style pasta tossed in creamy Alfredo sauce",
                      price: 11.5,
